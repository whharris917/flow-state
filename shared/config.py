...
This module contains application-wide constants used across all domains.
It has no dependencies on any other project module.

Moved from core/config.py as part of CR-2026-001 to eliminate false
dependency hub and establish clean domain boundaries.
"""
